...
class MouseoverHighlight:
    ...
    COLOURS  = ['black', 'snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white',
    ...
    def __init__(self, Widget, Root, Canvas_, highlightOption = 0x01, TextColour = 'red', highlight = 'red', defaultOutlineColour = 'black', OutlineWidth = 2, backgroundColour = 'gray' ):
        ...
        self.config_check( Widget, Root, Canvas_, highlightOption, TextColour, highlight, defaultOutlineColour, OutlineWidth, backgroundColour )
        self.highlight()
    ...
    def config_check(self, Widget, Root, Canvas_, highlightOption, TextColour, highlight, defaultOutlineColour, OutlineWidth, backgroundColour ):
        ...
        if ( (Root.__class__.__name__ != Tk.__name__) &
        ...
        if self.Canvas.type(Widget) not in MouseoverHighlight.Canvas_Items:
        ...
        print("OutlineWidth: ", OutlineWidth)
        print("Type: ", type(OutlineWidth))
        print("*****")
...
##############################################################################
    def changeTextColour(self):
        ...
        print("Colour Change initialized")
    ...
    def changeTextColour_enter(self, event = None):
        ...
        #print("Text Colour Change" )
        self.countEnter = self.countEnter + 1
        #print("Enter count: ", self.countEnter)
...
##############################################################################
    def changeTextBackground(self):
        ...
        print("background change initialized")
        self.coordinates = self.Canvas.bbox(self.Widget)
